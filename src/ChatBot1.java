...
public class ChatBot1
{
    ...
    private String transformIWantStatement(String statement)
    {
        ...
        return "How lit would it be if you had " + restOfStatement + "?";
    }
    ...
    private String transformIPreferToPlayThatBecauseICan(String statement){
        ...
        int psnofBecause = statement.indexOf("because");
    ...
    private String transformhowdoyoufeel(String statement){
        String feel = "";
        if(statement.indexOf("feel") >= 0 || statement.indexOf("feeling") >= 0 || statement.indexOf("how")>=0){
            if (emotion >= 0){
    ...
    private String [] randomNeutralResponses = {"Interesting, tell me more",
            ...
            "Oh word!",
            "I agree with you",
            "That sounds pretty lit. Do you want to play the guessing game? It's almost as good as Fortnite.(Say (I want to play the guessing game)",
            "Oof",
            "REEEEEEEEEEEEE",
            "why tho"
    };
    private String [] randomAngryResponses = {"Bahumbug.", "Harumph", "The rage consumes me!","You sound like a Fortnite default skin","Unlucky","Oof","Do you want to play the guessing game? It's almost as good as Fortnite.(Say (I want to play the guessing game)","REEEEEEEEEEEE"};
    private String [] randomHappyResponses = {"V I C T O R Y R O Y A L E", "Today is a good day to play some Fortnite", "You make me feel like a brand new Fortnite skin.","IT'S LTITTT","ESKETIT","Do you want to play the guessing game? It's almost as good as Fortnite.(Say (I want to play the guessing game)","Ya Yeet"};
